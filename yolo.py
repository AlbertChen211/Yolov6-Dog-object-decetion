        ...
        if crop:
            for i, c in list(enumerate(out_boxes)):
                ...
                if(x != []):
                  ...
                  crop_image = image.crop(x)
                else:
                  crop_image=image.crop([0,0,0,0])
                #crop_image.save(os.path.join(dir_save_path, "crop_" + img_name + ".png"), quality=95, subsampling=0)
                #print("save crop_" + img_name + ".png to " + dir_save_path)
        #---------------------------------------------------------#
        #   图像绘制
        #---------------------------------------------------------#
